...
<p align="center"><code>npm i -g @itamux/codex</code></p>
...
npm install -g @itamux/codex
# or
yarn global add @itamux/codex
# or
bun install -g @itamux/codex
# or
pnpm add -g @itamux/codex
```
...
You may need to upgrade to a more recent version with: `npm i -g @itamux/codex@latest`
